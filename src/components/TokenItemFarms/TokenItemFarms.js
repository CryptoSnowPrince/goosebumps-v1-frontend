        ...
        <>
          <div className={`d-flex justify-content-between mt-3  py-2 px-2 px-md-3 px-lg-4 first align-items-center ${detailShow ? `top-border` : `top-bottom-border`}`}>
            ...
            <div className='d-none d-lg-block'>
              ...
              <div className='earned-value'>Earned</div>
            </div>
            <div className='d-flex align-items-center'>
              <div>
                <div className='earned'>APR</div>
                <div style={{ color: "#04C0D7" }} className='earned-value'>34.99% &nbsp;</div>
              </div>
            ...
            <div className='d-flex align-items-center  d-none d-sm-flex'>
              <div>
                <div className='earned'>Liquidity</div>
                <div style={{ color: "#51FFA1" }} className='earned-value'>$252,529,752 &nbsp;</div>
              </div>
              <BiHelpCircle />
            </div>
            <div className='d-flex align-items-center d-none d-md-flex'>
              <div>
                <div className='earned'>Multiplier</div>
                <div style={{ color: "#51FFA1" }} className='earned-value'>40x &nbsp;</div>
              </div>
              <BiHelpCircle style={{ marginLeft: "25px" }} />
            </div>
            <div className='hand'>
          ...
          <div className='col-lg-4 col-md-6 col-xs-12 col-sm-12 p-2'>
            <div className={`third p-4 ${detailShow ? `top-border` : `top-bottom-border`}`}>
              ...
              <div className='d-flex justify-content-between align-items-center mt-2'>
                <div>Credit Calculation ended</div>
                <div>15954340 <BiHelpCircle /></div>
              </div>
              <div className='mt-2'>Recent CAKE Profit</div>
              <div className='mt-2'><small>1% Unstaking fee if withdrawn within 24h</small></div>
              <div className='mt-4 mb-4'>START EARNING</div>
            ...
            {detailShow && <div className='fourth p-4  bottom-border'>
              ...
              <div className='d-flex flex-column detail'>
                <div className='align-items-center d-flex justify-content-end'>Get Goose-BNB LP &nbsp;
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 2V6M14 2H10H14ZM14 2L8 8L14 2Z" stroke="#04C0D7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M14 8.66667V12.6667C14 13.0203 13.8595 13.3594 13.6095 13.6095C13.3594 13.8595 13.0203 14 12.6667 14H3.33333C2.97971 14 2.64057 13.8595 2.39052 13.6095C2.14048 13.3594 2 13.0203 2 12.6667V3.33333C2 2.97971 2.14048 2.64057 2.39052 2.39052C2.64057 2.14048 2.97971 2 3.33333 2H7.33333" stroke="#04C0D7" stroke-width="1.5" stroke-linecap="round" />
                  </svg>
                ...
                <div className='align-items-center d-flex justify-content-end'>See Pair Info &nbsp;
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 2V6M14 2H10H14ZM14 2L8 8L14 2Z" stroke="#04C0D7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M14 8.66667V12.6667C14 13.0203 13.8595 13.3594 13.6095 13.6095C13.3594 13.8595 13.0203 14 12.6667 14H3.33333C2.97971 14 2.64057 13.8595 2.39052 13.6095C2.14048 13.3594 2 13.0203 2 12.6667V3.33333C2 2.97971 2.14048 2.64057 2.39052 2.39052C2.64057 2.14048 2.97971 2 3.33333 2H7.33333" stroke="#04C0D7" stroke-width="1.5" stroke-linecap="round" />
                  </svg>
