...
const PortfolioTracker = () => {
  ...
  const fetchLiveInfo = async (tokens) => {
    ...
    tokens.map((item) => {
      item.info =
        query
          .where((x) => x.token === item.pair.buyCurrency.address)
          .singleOrDefault() || {};
      ...
      item.info.tokenscale = numberHelper.calculateTokenscale(
        item.info.isETH ? item.info.price * infos.ethPrice : item.info.price
      );
          ...
          <div className="row">
                  ...
                  <div className="mt-2" key={index}>
                    ...
                    {addresses.length > 1 ? (
                      <button
                        ...
                        className="default-btn btn-sq px-3 py-2"
                      >
            ...
            <div className="col-lg-6 text-right mt-auto">
              <p>
                ...
                <label>
                  <i className="fa fa-circle red" aria-hidden="true"></i> Sold
                </label>
                <br />
                Profit :
                <label>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      {token.info.isETH ? (
                        <>
                          <NumberFormat
                            value={token.info.price * ethPrice}
                    ...
                    <td>
                      {token.info.isETH ? (
                        <>
                          <NumberFormat
                            value={
                              token.info.balance * token.info.price * ethPrice
                            }
                            decimalScale="2"
                            displayType="text"
                            thousandSeparator=","
